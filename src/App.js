...
import pro22 from "./pro22.png"; // Import the second profile image
              ...
              <div className="container mx-auto flex items-center justify-center py-20">
                <div className="flex flex-col md:flex-row items-center md:items-start w-full">
                  ...
                  <div className="md:w-1/2 p-4 flex justify-center items-center relative">
                    ...
                    />
                    <img
                      src={hover ? pro22 : profile}
                      alt="Profile"
                      className="profile-image rounded-lg shadow-lg max-w-full max-h-full object-contain"
